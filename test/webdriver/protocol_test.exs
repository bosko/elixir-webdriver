...
defmodule WebDriverProtocolTest do
  ...
  test "start_session" do
    test_post(
      &Protocol.start_session(&1, %{desiredCapabilities: []}),
      "/session",
      "{\"desiredCapabilities\":[]}"
    )
  end
  ...
  test "set_timeout" do
    test_post(
      &Protocol.set_timeout(&1, @session_id, %{type: "script", ms: 1000}),
  ...
  test "set_async_script_timeout" do
    test_post(
      &Protocol.set_async_script_timeout(&1, @session_id, %{ms: 1000}),
  ...
  test "set_implicit_wait_timeout" do
    test_post(
      &Protocol.set_implicit_wait_timeout(&1, @session_id, %{ms: 1000}),
  ...
  test "url/3" do
    test_post(
      &Protocol.url(&1, @session_id, %{url: "http://google.com"}),
  ...
  test "execute" do
    test_post(
      &Protocol.execute(&1, @session_id, %{script: "alert('Hello world!')", args: []}),
      "/session/:session_id/execute",
      "{\"script\":\"alert('Hello world!')\",\"args\":[]}"
    )
  end

  test "execute_async" do
    test_post(
      &Protocol.execute_async(&1, @session_id, %{script: "alert('Hello world!')", args: []}),
  ...
  test "frame" do
    test_post(
      &Protocol.frame(&1, @session_id, %{id: "frame"}),
  ...
  test "window" do
    test_post(
      &Protocol.window(&1, @session_id, %{name: "window"}),
  ...
  test "window_size/3" do
    test_get(
      &Protocol.window_size(&1, @session_id, "window_handle"),
  ...
  test "window_size/4" do
    test_post(
      &Protocol.window_size(&1, @session_id, "window_handle", %{height: 240, width: 320}),
      "/session/:session_id/window/window_handle/size",
  ...
  test "window_position/2" do
    test_get(
      &Protocol.window_position(&1, @session_id),
  ...
  test "window_position/3" do
    test_get(
      &Protocol.window_position(&1, @session_id, "window_handle"),
  ...
  test "window_position/4" do
    test_post(
      &Protocol.window_position(&1, @session_id, "window_handle", %{x: 100, y: 200}),
      "/session/:session_id/window/window_handle/position",
      "{\"x\":100,\"y\":200}"
    )
  end
  ...
  test "maximize_window" do
    test_post(
      &Protocol.maximize_window(&1, @session_id, "window_handle"),
  ...
  test "set_cookie" do
    test_post(
      &Protocol.set_cookie(&1, @session_id, %{cookie: %{key: "value"}}),
  ...
  test "delete cookie" do
    test_delete(
      &Protocol.delete_cookie(&1, @session_id, "name"),
  ...
  test "element/3" do
    test_post(
      &Protocol.element(&1, @session_id, %{using: "css selector", value: "special"}),
  ...
  test "element/4" do
    test_post(
      &Protocol.element(&1, @session_id, ":element_id", %{using: "css selector", value: "special"}),
  ...
  test "elements/3" do
    test_post(
      &Protocol.elements(&1, @session_id, %{using: "css selector", value: "special"}),
  ...
  test "elements/4" do
    test_post(
      &Protocol.elements(&1, @session_id, ":element_id", %{
        using: "css selector",
        value: "special"
      }),
  ...
  test "element_by_id" do
    test_get(
      &Protocol.element_by_id(&1, @session_id, ":element_id"),
  ...
  test "click" do
    test_post(
      &Protocol.click(&1, @session_id, ":element_id"),
  ...
  test "submit" do
    test_post(
      &Protocol.submit(&1, @session_id, ":element_id"),
  ...
  test "text" do
    test_get(
      &Protocol.text(&1, @session_id, ":element_id"),
  ...
  test "value" do
    test_post(
      &Protocol.value(&1, @session_id, ":element_id", %{value: ["a", "b", "c"]}),
  ...
  test "keys" do
    test_post(
      &Protocol.keys(&1, @session_id, %{value: ["a", "b", "c"]}),
  ...
  test "name" do
    test_get(
      &Protocol.name(&1, @session_id, ":element_id"),
  ...
  test "clear" do
    test_post(
      &Protocol.clear(&1, @session_id, ":element_id"),
  ...
  test "selected" do
    test_get(
      &Protocol.selected(&1, @session_id, ":element_id"),
  ...
  test "enabled" do
    test_get(
      &Protocol.enabled(&1, @session_id, ":element_id"),
  ...
  test "attribute" do
    test_get(
      &Protocol.attribute(&1, @session_id, ":element_id", "attribute_name"),
  ...
  test "equals" do
    test_get(
      &Protocol.equals(&1, @session_id, ":element_id", "other_id"),
  ...
  test "displayed" do
    test_get(
      &Protocol.displayed(&1, @session_id, ":element_id"),
  ...
  test "location" do
    test_get(
      &Protocol.location(&1, @session_id, ":element_id"),
  ...
  test "location_in_view" do
    test_get(
      &Protocol.location_in_view(&1, @session_id, ":element_id"),
  ...
  test "size" do
    test_get(
      &Protocol.size(&1, @session_id, ":element_id"),
  ...
  test "css" do
    test_get(
      &Protocol.css(&1, @session_id, ":element_id", "property_name"),
  ...
  test "orientation/2" do
    test_get(
      &Protocol.orientation(&1, @session_id),
  ...
  test "orientation/3" do
    test_post(
      &Protocol.orientation(&1, @session_id, %{orientation: "LANDSCAPE"}),
      "/session/:session_id/orientation",
  ...
  test "alert_text/2" do
    test_get(
      &Protocol.alert_text(&1, @session_id),
  ...
  test "alert_text/3" do
    test_post(
      &Protocol.alert_text(&1, @session_id, %{text: "Help!"}),
      "/session/:session_id/alert_text",
      "{\"text\":\"Help!\"}"
    )
  end
  ...
  test "accept_alert" do
    test_post(
      &Protocol.accept_alert(&1, @session_id),
  ...
  test "dismiss_alert" do
    test_post(
      &Protocol.dismiss_alert(&1, @session_id),
  ...
  test "move_to" do
    test_post(
      &Protocol.move_to(&1, @session_id, %{element: "element_id", offsetx: 10, offsety: 20}),
  ...
  test "mouse_click/2" do
    test_post(&Protocol.mouse_click(&1, @session_id), "/session/:session_id/click", "{}")
  end

  test "mouse_click/3" do
    test_post(
      &Protocol.mouse_click(&1, @session_id, %{button: 2}),
  ...
  test "mouse_button_down/2" do
    test_post(
      &Protocol.mouse_button_down(&1, @session_id),
  ...
  test "mouse_button_down/3" do
    test_post(
      &Protocol.mouse_button_down(&1, @session_id, %{button: 1}),
      "/session/:session_id/buttondown",
      "{\"button\":1}"
    )
  end
  ...
  test "mouse_button_up/2" do
    test_post(&Protocol.mouse_button_up(&1, @session_id), "/session/:session_id/buttonup", "{}")
  end

  test "mouse_button_up/3" do
    test_post(
      &Protocol.mouse_button_up(&1, @session_id, %{button: 1}),
  ...
  test "mouse_double_click/2" do
    test_post(
      &Protocol.mouse_double_click(&1, @session_id),
  ...
  test "mouse_double_click/3" do
    test_post(
      &Protocol.mouse_double_click(&1, @session_id, %{button: 2}),
      "/session/:session_id/doubleclick",
      "{\"button\":2}"
    )
  end
  ...
  test "touch_click" do
    test_post(
      &Protocol.touch_click(&1, @session_id, %{element: "element_id"}),
  ...
  test "touch_down" do
    test_post(
      &Protocol.touch_down(&1, @session_id, %{x: 100, y: 200}),
  ...
  test "touch_up" do
    test_post(
      &Protocol.touch_up(&1, @session_id, %{x: 100, y: 200}),
  ...
  test "touch_move" do
    test_post(
      &Protocol.touch_move(&1, @session_id, %{x: 100, y: 200}),
  ...
  test "touch_scroll" do
    test_post(
      &Protocol.touch_scroll(&1, @session_id, %{element: "element_id", x: 100, y: 200}),
  ...
  test "touch_double_click" do
    test_post(
      &Protocol.touch_double_click(&1, @session_id, %{element: "element_id"}),
  ...
  test "touch_long_click" do
    test_post(
      &Protocol.touch_long_click(&1, @session_id, %{element: "element_id"}),
  ...
  test "touch_flick" do
    test_post(
      &Protocol.touch_flick(&1, @session_id, %{xSpeed: 10, ySpeed: 0}),
  ...
  test "geo_location/2" do
    test_get(
      &Protocol.geo_location(&1, @session_id),
  ...
  test "geo_location/3" do
    test_post(
      &Protocol.geo_location(&1, @session_id, %{longitude: 23.34, lattitude: 40.3, altitude: 10.3}),
      "/session/:session_id/location",
      "{\"longitude\":23.34,\"lattitude\":40.3,\"altitude\":10.3}"
    )
  end
  ...
  def post(_url, options) do
    ...
    %HTTPoison.Response{
      body: "{\"sessionId\": \"1234\", \"status\": 0, \"value\": #{Jason.encode!(body)}}",
      status_code: 201,
      headers: []
    }
  end
  ...
  def get(_url, _options) do
    %HTTPoison.Response{
      body: "{\"sessionId\": \"1234\", \"status\": 0, \"value\": #{Jason.encode!(%{})}}",
      status_code: 200,
      headers: []
    }
  end
